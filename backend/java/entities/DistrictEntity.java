package com.yourschemes.portal.entity;
...
public class DistrictEntity {
    ...
    public DistrictEntity(String districtCode, String districtNameEn, String districtNameTa,
            String collectorOfficeAddress, String agricultureOfficeAddress, List<String> majorCrops,
            Double averageRainfallMm, List<String> soilTypes, String climateZone) {
    ...
    public String getDistrictNameTa() {
        return districtNameTa;
    }

    public void setDistrictNameTa(String districtNameTa) {
        this.districtNameTa = districtNameTa;
    }

    public String getCollectorOfficeAddress() {
        return collectorOfficeAddress;
    }

    public void setCollectorOfficeAddress(String collectorOfficeAddress) {
        this.collectorOfficeAddress = collectorOfficeAddress;
    }

    public String getAgricultureOfficeAddress() {
        return agricultureOfficeAddress;
    }

    public void setAgricultureOfficeAddress(String agricultureOfficeAddress) {
        this.agricultureOfficeAddress = agricultureOfficeAddress;
    }

    public List<String> getMajorCrops() {
        return majorCrops;
    }

    public void setMajorCrops(List<String> majorCrops) {
        this.majorCrops = majorCrops;
    }

    public Double getAverageRainfallMm() {
        return averageRainfallMm;
    }

    public void setAverageRainfallMm(Double averageRainfallMm) {
        this.averageRainfallMm = averageRainfallMm;
    }
